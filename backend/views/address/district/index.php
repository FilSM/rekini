 ...
 * @var common\models\address\search\DistrictSearch $searchModel
 */
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute'=>'region_id',
                'value' => function ($model) {
                    return Html::a($model->region_name, ['region/view', 'id' => $model->region_id]);
                }, 
                'format'=>'raw',        
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => $dataFilterRegion,
                'filterWidgetOptions'=>['pluginOptions' => ['allowClear' => true],],
                'filterInputOptions' => ['placeholder' => Yii::t('common', 'Any...')],                        
            ],
            [
                'attribute'=>'city_id',
                'value' => function ($model) {
                    return Html::a($model->city_name, ['city/view', 'id' => $model->city_id]);
                }, 
                'format'=>'raw',        
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => $dataFilterCity,
                'filterWidgetOptions'=>['pluginOptions' => ['allowClear' => true],],
                'filterInputOptions' => ['placeholder' => Yii::t('common', 'Any...')],                        
            ],
            'name',
