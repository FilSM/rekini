...
/**
 * ClientRoleSearch represents the model behind the search form of `common\models\client\ClientRole`.
 */
class ClientRoleSearch extends ClientRole
{
    /**
     * @inheritdoc
     */
