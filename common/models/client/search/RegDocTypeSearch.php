...
/**
 * RegDocTypeSearch represents the model behind the search form of `common\models\client\RegDocType`.
 */
class RegDocTypeSearch extends RegDocType
{
    /**
     * @inheritdoc
     */
