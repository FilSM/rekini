...
/**
 * ClientManagerSearch represents the model behind the search form of `common\models\client\ClientManager`.
 */
class ClientManagerSearch extends ClientManager
{
    ...
    public function rules()
    {
        return [
            ...
            [['first_name', 'last_name', 'phone', 'email', 'term_from', 'term_till', 'share', 'position_name'], 'safe'],
        ];
    }
