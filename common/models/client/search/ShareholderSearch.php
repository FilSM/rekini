...
use common\models\client\Shareholder;

/**
 * ShareholderSearch represents the model behind the search form of `common\models\client\Shareholder`.
 */
class ShareholderSearch extends Shareholder
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            $baseTableName.'.shareholder_id' => $this->shareholder_id,
