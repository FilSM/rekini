 ...
 */
class ShareholderController extends FilSMController
{
    ...
    {
        parent::init();
        $this->defaultModel = 'common\models\client\Shareholder';
        $this->defaultSearchModel = 'common\models\client\search\ShareholderSearch';
    }
    ...
    public function actionIndex($client_id = null) {
        ...
        if(!$isAdmin){
            $params['deleted'] = (empty($params) || empty($params['ShareholderSearch'])) ?
                    0 :
                    (isset($params['ShareholderSearch']['deleted']) && ($params['ShareholderSearch']['deleted'] !== '') ?
                            $params['ShareholderSearch']['deleted'] :
                            0
                    );
        }
