...
//}else{
    $this->title = Yii::t($model->tableName(), 'Update a '.$model->modelTitle(2, false)) . ': ' . $model->client->name;
//}
...
$this->params['breadcrumbs'][] = ['label' => $model->client->name, 'url' => ['view', 'id' => $model->id, 'client_id' => $clientModel->id]];
